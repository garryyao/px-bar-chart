...
function runBaseTests() {
  px_barchart_1 = document.getElementById('px_barchart_1');

  suite('Base Automation Tests for px-barchart', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-barchart fixture is created', function() {
      assert.isTrue(document.getElementById('px_barchart_1') !== null);
    });
